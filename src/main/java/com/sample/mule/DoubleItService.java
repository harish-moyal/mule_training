 ...
 * 2015-04-06T22:53:11.309+05:30
 * Generated source version: 2.5.1
 * 
 */
@WebServiceClient(name = "DoubleItService", 
                  wsdlLocation = "file:/C:/Mule-workspace/workspace/soap-ws-mule/src/main/resources/example-soap-ws.wsdl",
...
public class DoubleItService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Mule-workspace/workspace/soap-ws-mule/src/main/resources/example-soap-ws.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DoubleItService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Mule-workspace/workspace/soap-ws-mule/src/main/resources/example-soap-ws.wsdl");
        }
        WSDL_LOCATION = url;
    }
